        ...
        <nav class="mt-0 pt-0">
            <ul id="sidebar" class="fixed bg-[#1E9E9E] w-20 h-screen p-4 text-white z-50 transition-all duration-300 ease-in-out">
                ...
                <li class="mb-4 pl-3 py-3 transition-colors duration-200 <?php echo ($currentPage == 'dashboard.php') ? 'bg-white text-[#1E9E9E] rounded' : 'hover:bg-white hover:text-[#1E9E9E] hover:rounded'; ?>">
                    <a href="dashboard.php" class="flex items-center <?php echo ($currentPage == 'dashboard.php') ? 'text-[#1E9E9E]' : 'text-white hover:text-[#1E9E9E]'; ?>">
